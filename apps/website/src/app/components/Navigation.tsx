...
export function Navbar({ links, includeIcon, specialElements, style }:
    ...
    return <div className=" w-full overflow-x-hidden h-nav">
        <nav className='flex flex-row px-5 py-3 h-full w-full items-center align-middle bg-white sticky mb-8'
            ...
            <div className="w-fit whitespace-nowrap mr-auto text-xl hidden lg:block tracking-wide flex-auto overflow-hidden" style={{ maxWidth: 'max(0px, calc((100% - 120px)*999))' }}>
