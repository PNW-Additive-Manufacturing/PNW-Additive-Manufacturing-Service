...
export function ModelMesh({ ref }: { ref: React.Ref<Mesh<BufferGeometry>> }) {
	...
	const [boundingGeometry, setBoundingGeometry] = useState<
	...
	return (
		<group>
			...
			/>
			{boundingGeometry == undefined ? undefined : (
				<mesh
					position={new Vector3(0, 1, 0)}
	...
	return (
		<group>
			...
			<lineSegments
				...
				args={[outlineGeometry, outlineMaterial]}></lineSegments>
			<gridHelper
				args={[
					20,
					20,
		...
		<div style={{ width: "100%", height: "600px" }}>
			<div className="w-fit h-2/5 bg-slate-50 rounded-md p-3 grid gap-4">
				<div style={{ gridColumn: 1 }}>
					<button className="rounded-sm p-4 font-medium block">
						U
					</button>
					<button className="rounded-sm p-4 font-medium block">
						R
